module managers {
    export class ScoreBoard {
        ...
        // public methods
        public Start() {
            this._livesLabel = new objects.Label("Lives: 5", "30px", "Consolas", "#FFFF00", 20, 20, false);
            this._scoreLabel = new objects.Label("Score: 0", "30px", "Consolas", "#FFFF00", 450, 20, false);
            this._highScoreLabel = new objects.Label("High Score: 0", "60px", "Consolas", "#FFFF00", config.Screen.HALF_WIDTH, config.Screen.HALF_HEIGHT, true);
